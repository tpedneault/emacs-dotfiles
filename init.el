...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ivy-yasnippet yasnippet lua-mode cmake-font-lock cmake-mode vterm doom-modeline exec-path-from-shell php-mode hover lsp-dart magit telephone-line spaceline-all-the-icons spaceline smartparens color-theme-sanityinc-tomorrow company lsp-treemacs lsp-ivy monokai-theme obsidian-theme zenburn-theme lsp-ui lsp-mode web-mode treemacs-all-the-icons page-break-lines all-the-icons-ivy-rich ivy-rich counsel all-the-icons-ivy evil-collection dashboard cmake-ide irony-mode rtags-helm company-rtags js2-mode vue-mode company-mode go-mode-load go-imports go-mode dracula-theme treemacs-icons-dired treemacs-projectile treemacs-evil projectile org-sticky-header gruvbox-theme badger-theme rustic which-key dap-mode helm-lsp robe all-the-icons neotree yasnippet-snippets flycheck irony-eldoc company-irony minions mood-line atom-one-dark-theme evil helm use-package))
